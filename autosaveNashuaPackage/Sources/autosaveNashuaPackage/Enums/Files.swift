...
//                print("Type '\(type)' --> \(t) has not been implemented. Skipping load.")
//                return nil
//            }
//        }
//        
...
//                    } else {
//                        throw CustomError("Failed to parse contents")
//                    }
//                } else {
//                    throw CustomError("File does not exist")
//                }
//            } catch {
//                print("Error in loadImageData for url '\(url)': \(error.localizedDescription)")
//            }
//            return nil
//        }
//
...
//    }
//    
//    public static func load<T>(_ url: URL) -> T? {
//        do {
//            // 2. Load the file data
//            if let content = Content(T.self, url) {
//                if let t = content.load() as? T {
//                    return t
//                } else {
...
//            }
//        } catch {
//            print("Error in load for type T '\(T.self)' data from url '\(url)': \(error.localizedDescription)")
//        }
//        
//        return nil
//    }
