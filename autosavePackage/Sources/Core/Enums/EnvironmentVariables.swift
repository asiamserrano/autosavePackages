...
public enum EnvironmentVariables {
    ...
    public static let APP_NAME = ProcessInfo.processInfo.environment["APP_NAME"]!
    public static let APP_DIRECTORY = ProcessInfo.processInfo.environment["APP_DIRECTORY"]!
